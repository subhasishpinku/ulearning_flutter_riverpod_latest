...
import 'package:ulearning/pages/profile/buy_course/buy_course_controller.dart';

class BuyCourse extends ConsumerStatefulWidget {
  const BuyCourse({super.key});

  @override
  ConsumerState<BuyCourse> createState() => _BuyCoursePage();
}

class _BuyCoursePage extends ConsumerState<BuyCourse> {


  @override
  Widget build(BuildContext context) {
    final asyncCourseList = ref.watch(asyncNotifierBuyCourseControllerProvider);
      return Container(
          color: Colors.white,
          child: SafeArea(
          child: Scaffold(
